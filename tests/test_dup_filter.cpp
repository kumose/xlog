#include "includes.h"
#include <xlog/sinks/dup_filter_sink.h>
#include "test_sink.h"

TEST_CASE("dup_filter_test1", "[dup_filter_sink]") {
    using xlog::sinks::dup_filter_sink_st;
    ...
    for (int i = 0; i < 10; i++) {
        dup_sink.log(xlog::details::log_msg{"test", xlog::level::info, "message1"});
    }
...
TEST_CASE("dup_filter_test3", "[dup_filter_sink]") {
    ...
    for (int i = 0; i < 10; i++) {
        dup_sink.log(xlog::details::log_msg{"test", xlog::level::info, "message1"});
        dup_sink.log(xlog::details::log_msg{"test", xlog::level::info, "message2"});
    }
...
TEST_CASE("dup_filter_test4", "[dup_filter_sink]") {
    using xlog::sinks::dup_filter_sink_mt;
    using xlog::sinks::test_sink_mt;
    ...
    dup_sink.log(xlog::details::log_msg{"test", xlog::level::info, "message"});
