...
// -----------------------------------------------------------------------------
//
// This header file defines the xlog::log_internal::NoDestructor<T> wrapper for defining a
...
namespace xlog::log_internal {
    // xlog::log_internal::NoDestructor<T>
    //
    ...
    //
    // An instance of xlog::log_internal::NoDestructor<T> has similar type semantics to an
    // instance of T:
    //
    ...
    //    constinit xlog::log_internal::NoDestructor<MyRegistry> reg{"foo", "bar", 8008};
    //
    ...
    //      static const xlog::log_internal::NoDestructor<std::string> x("foo");
    //      return *x;
    //    }
    //
    ...
    //
    //   // Prefer using xlog::log_internal::NoDestructor<T> instead for the static variable.
    //   const std::string& MyString() {
...
#elif KUMO_HAVE_BUILTIN(__builtin_launder)
