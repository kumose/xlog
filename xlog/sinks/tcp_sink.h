...
#ifdef _WIN32
#include <xlog/details/tcp_client-windows.h>
#else
#include <xlog/details/tcp_client.h>
#endif
...
class tcp_sink : public xlog::sinks::base_sink<Mutex> {
public:
...
using tcp_sink_st = tcp_sink<xlog::details::null_mutex>;
