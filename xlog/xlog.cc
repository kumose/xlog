...
template XLOG_API xlog::logger::logger(std::string name,
                                           sinks_init_list::iterator begin,
                                           sinks_init_list::iterator end);
template class XLOG_API xlog::sinks::base_sink<std::mutex>;
template class XLOG_API xlog::sinks::base_sink<xlog::details::null_mutex>;
